...
export const Map: React.FC<MapProps> = ({
    ...
    if (!L) {
        return (
            <div className="bg-[#1A1A1D] border border-[#29292E] rounded-md p-4" style={{ height: '400px' }}>
                <div className="flex flex-col items-center justify-center h-full">
                    ...
                    {vehicles && vehicles.length > 0 ? (
                        <div className="bg-[#1A1A1D] p-4 rounded-md border border-[#29292E] shadow-sm w-full max-w-lg">
                            <h3 className="font-bold mb-2 text-[#E1E1E6]">Visualização Alternativa de Veículos</h3>
                            <div className="overflow-y-auto max-h-64">
                                <table className="min-w-full divide-y divide-[#29292E]">
                                    <thead className="bg-[#121214]">
                                        <tr>
                                            <th className="px-3 py-2 text-left text-xs font-medium text-[#C4C4CC] uppercase tracking-wider">Placa</th>
                                            <th className="px-3 py-2 text-left text-xs font-medium text-[#C4C4CC] uppercase tracking-wider">Modelo</th>
                                            <th className="px-3 py-2 text-left text-xs font-medium text-[#C4C4CC] uppercase tracking-wider">Status</th>
                                        </tr>
                                    </thead>
                                    <tbody className="bg-[#1A1A1D] divide-y divide-[#29292E]">
                                        {vehicles.map((vehicle) => (
                                            ...
                                            >
                                                <td className="px-3 py-2 whitespace-nowrap text-sm text-[#E1E1E6]">{vehicle.placa}</td>
                                                <td className="px-3 py-2 whitespace-nowrap text-sm text-[#E1E1E6]">{vehicle.modelo}</td>
