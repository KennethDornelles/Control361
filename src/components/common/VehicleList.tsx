    ...
    return (
        <div className="bg-[#1A1A1D] shadow rounded-lg overflow-hidden border border-[#29292E]">
            <div className="p-4 bg-[#1A1A1D] border-b border-[#29292E]">
                ...
                <p className="text-sm text-gray-400">Total: {vehicles.length} veículos</p>
            </div>
                            ...
                            >
                                <div className="flex justify-between">
                                    <div>
                                        ...
                                        {vehicle.motorista && (
                                            <p className="text-xs text-gray-400">Motorista: {vehicle.motorista}</p>
                                        )}
                                    </div>
                                    <div className="text-right">
                                        <span
                                            className={`inline-block px-2 py-1 text-xs rounded-full ${vehicle.status === VehicleStatus.ATIVO || vehicle.status === VehicleStatus.MOVIMENTO
                                        ...
                                        <p className="text-xs text-gray-400 mt-1">{vehicle.velocidade} km/h</p>
                                    </div>
                                </div>
